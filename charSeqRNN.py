...
class charSeqRNN(object):
    ...
    def inference(self):
        ...
        savenewDict = {}
        savenewDict['inputFeatures'] = allInputFeatures

        if self.args['inferenceOutputFileName']!='None':
            scipy.io.savemat(self.args['inferenceOutputFileName'], saveDict)
        if self.args['inferenceinputFeaturesFileName']!='None':
            scipy.io.savemat(self.args['inferenceinputFeaturesFileName'], savenewDict)
        return retDict
...
def getDefaultRNNArgs():
    ...
    for x in range(len(dataDirs)):
        ...
        args['syntheticDatasetDir_'+str(x)] = rootDir+'Step3new_SyntheticSentences/'+cvPart+'/'+dataDirs[x]+'_syntheticSentences/'
    ...
    #args['loadDir'] = '../handwritingBCIData/RNNTrainingSteps/Step4new_RNNTraining/HeldOutTrials'
    args['loadDir'] = 'None'
    ...
    args['directionality'] = 'bidirectional'
    ...
    args['inferenceinputFeaturesFilename'] = 'None'
